...
<body>
    ...
    <div class="container">
        ...
        <section class="mb-6">
            ...
            <pre class="ms-5 mb-5"><code class="language-php"><?php echo $phpformbuilder_include_code; ?></code></pre>
            <?php if ($phpformbuilder_include_code != 'include_once rtrim($_SERVER[\'DOCUMENT_ROOT\'], DIRECTORY_SEPARATOR) . \'/phpformbuilder/Form.php\';') { ?>
            <hr>
            <p class="ms-5 mb-5"><strong>You have to replace the following code:<br> <code class="language-php">include_once rtrim($_SERVER['DOCUMENT_ROOT'], DIRECTORY_SEPARATOR) . '/phpformbuilder/Form.php';</code><br>in your forms - the template files or your own forms php files - with the correct include statement shown above.</strong></p>
            <?php } else { ?>
